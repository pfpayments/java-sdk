...
The PostFinanceCheckout Java SDK is used to interact with PostFinanceCheckout`s REST API.
...
```groovy
  ...
  dependencies {
     implementation "ch.postfinance:postfinancecheckout-java-sdk:9.4.0"
  }
```
...
import ch.postfinancecheckout.sdk.service.TransactionsService;
