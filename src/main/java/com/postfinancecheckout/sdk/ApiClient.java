...
import com.postfinancecheckout.sdk.auth.Authentication;
import com.postfinancecheckout.sdk.auth.HttpBasicAuth;
import com.postfinancecheckout.sdk.auth.ApiKeyAuth;
import com.postfinancecheckout.sdk.auth.OAuth;
...
public class ApiClient {
    ...
    private String basePath = "https://checkout.postfinance.ch:443/api";
    ...
    public ApiClient(long userId, String applicationKey) {
        ...
        setUserAgent("com.postfinancecheckout.postfinancecheckout-java-sdk-2.0.11");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://checkout.postfinance.ch:443/api
