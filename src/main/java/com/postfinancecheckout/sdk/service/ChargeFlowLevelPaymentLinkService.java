...
import com.postfinancecheckout.sdk.model.ChargeFlowLevelPaymentLink;
...
public class ChargeFlowLevelPaymentLinkService {
  ...
  /**
    ...
    * @see <a href="https://checkout.postfinance.ch/doc/api/web-service#charge-flow-level-payment-link-service--count">Count Documentation</a>
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://checkout.postfinance.ch/doc/api/web-service#charge-flow-level-payment-link-service--read">Read Documentation</a>
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://checkout.postfinance.ch/doc/api/web-service#charge-flow-level-payment-link-service--search">Search Documentation</a>
