...
import ch.postfinance.sdk.model.SubscriptionMetricUsageReport;
import ch.postfinance.sdk.model.SubscriptionMetricUsageReportCreate;
...
public class SubscriptionMetricUsageService {
  ...
  /**
    ...
    * @see <a href="https://checkout.postfinance.ch/doc/api/web-service/v1#subscription-metric-usage-service--count">Count Documentation</a>
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://checkout.postfinance.ch/doc/api/web-service/v1#subscription-metric-usage-service--create">Create Documentation</a>
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://checkout.postfinance.ch/doc/api/web-service/v1#subscription-metric-usage-service--read">Read Documentation</a>
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://checkout.postfinance.ch/doc/api/web-service/v1#subscription-metric-usage-service--search">Search Documentation</a>
