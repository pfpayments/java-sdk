...
public class PaymentMethodService {
  ...
  /**
    ...
    * @see <a href="https://checkout.postfinance.ch/doc/api/web-service/v1#payment-method-service--all">All Documentation</a>
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://checkout.postfinance.ch/doc/api/web-service/v1#payment-method-service--read">Read Documentation</a>
