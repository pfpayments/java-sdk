...
import ch.postfinance.checkout.sdk.model.ShopifySubscriptionCreationRequest;
import ch.postfinance.checkout.sdk.model.ShopifySubscriptionUpdateAddressesRequest;
import ch.postfinance.checkout.sdk.model.ShopifySubscriptionUpdateRequest;
import ch.postfinance.checkout.sdk.model.ShopifySubscriptionVersion;
...
public class ShopifySubscriptionService {
  ...
  /**
    ...
    * @see <a href="https://checkout.postfinance.ch/doc/api/web-service#shopify-subscription-service--count">Count Documentation</a>
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://checkout.postfinance.ch/doc/api/web-service#shopify-subscription-service--create">Create Documentation</a>
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://checkout.postfinance.ch/doc/api/web-service#shopify-subscription-service--read">Read Documentation</a>
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://checkout.postfinance.ch/doc/api/web-service#shopify-subscription-service--search">Search Documentation</a>
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://checkout.postfinance.ch/doc/api/web-service#shopify-subscription-service--terminate">Terminate Documentation</a>
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://checkout.postfinance.ch/doc/api/web-service#shopify-subscription-service--update">Update Documentation</a>
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://checkout.postfinance.ch/doc/api/web-service#shopify-subscription-service--update-addresses">Update Addresses Documentation</a>
