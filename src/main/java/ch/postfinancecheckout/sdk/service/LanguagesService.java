...
import ch.postfinancecheckout.sdk.model.LanguageListResponse;
import ch.postfinancecheckout.sdk.model.LanguageSearchResponse;
import ch.postfinancecheckout.sdk.model.RestApiErrorResponse;
import ch.postfinancecheckout.sdk.model.RestLanguage;
...
public class LanguagesService extends BaseApi {
   ...
   * 
   * @see <a href="https://checkout.postfinance.ch/doc/api/web-service#getLanguages">List all languages Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://checkout.postfinance.ch/doc/api/web-service#getLanguagesCode">Retrieve a language Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://checkout.postfinance.ch/doc/api/web-service#getLanguagesSearch">Search languages Documentation</a>
   */
