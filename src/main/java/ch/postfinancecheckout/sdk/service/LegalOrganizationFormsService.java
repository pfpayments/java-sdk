...
import ch.postfinancecheckout.sdk.model.LegalOrganizationFormListResponse;
import ch.postfinancecheckout.sdk.model.LegalOrganizationFormSearchResponse;
...
public class LegalOrganizationFormsService extends BaseApi {
   ...
   * 
   * @see <a href="https://checkout.postfinance.ch/doc/api/web-service#getLegalOrganizationForms">List all legal organization forms Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://checkout.postfinance.ch/doc/api/web-service#getLegalOrganizationFormsId">Retrieve a legal organization form Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://checkout.postfinance.ch/doc/api/web-service#getLegalOrganizationFormsSearch">Search legal organization forms Documentation</a>
   */
