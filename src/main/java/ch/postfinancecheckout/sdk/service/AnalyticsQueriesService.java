...
public class AnalyticsQueriesService extends BaseApi {
   ...
   * 
   * @see <a href="https://checkout.postfinance.ch/doc/api/web-service#deleteAnalyticsQueriesQueryToken">Cancel a query execution Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://checkout.postfinance.ch/doc/api/web-service#getAnalyticsQueriesQueryToken">Retrieve a query execution information Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://checkout.postfinance.ch/doc/api/web-service#getAnalyticsQueriesQueryTokenResult">Generate a temporary URL to download the query result Documentation</a>
   */
